...
public enum EnumResult {
    ...
    ERROR_AUTHORIZATION_DEFINED(401, "authorization access undefined, sign in again"),
    ERROR_NO_FOUND(404, "resources no found"),
    ERROR_SERVER(500, "server inner exception"),
    ...
    ERROR_EMAIL_NOT_EXISTS(4004, "email not exists"),
    ERROR_EMAIL_NO_ACTIVATE(4004, "email does not activate"),
